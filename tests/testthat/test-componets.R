...
test_that("farquhar works", {
  # Randomly select the values to use as inputs, also note that this expected value comes from 
  # the Dietz function
  Vcmax <- 18
  Jmax <- Vcmax * 1.67 
  Rleaf <- 10 
...
test_that("solve.FVcB works", {
  ...
  out <- solve.FVcB(Vcmax = 18, Jmax = 30.06, Rleaf = 1, Gstar = 0.5, alpha = 0.3, 
